---
website: "Serviços online do Município de Mondim de Basto"          # Entre as aspas escreve o nome do website
date: "20/07/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://servicosonline.cm-mondimdebasto.pt/"   # Entre as aspas escreve o domínio do website
...
Consulte aqui a última atualização: [Relatório Serviços online do Município de Mondim de Basto](report.html)
